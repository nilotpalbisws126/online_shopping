<%@ Page Title="" Language="C#" MasterPageFile="~/view/site.master" AutoEventWireup="true" CodeFile="men.aspx.cs" Inherits="view_Default" %>
...
<p>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT product_name, img, price, product_id FROM products WHERE (product_id LIKE 'm%') OR (product_id LIKE 'M%')">
    </asp:SqlDataSource>
</p>
</asp:Content>
