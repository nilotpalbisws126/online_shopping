<%@ Page Title="" Language="C#" MasterPageFile="~/view/site.master" AutoEventWireup="true" CodeFile="search.aspx.cs" Inherits="view_Default" %>
...
<p>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT product_name, img, price, product_id FROM products WHERE (product_id LIKE '%' + @product + '%') OR (product_name LIKE '%' + @product + '%') OR (descrip LIKE '%' + @product + '%')">
        <SelectParameters>
            <asp:SessionParameter Name="product" SessionField="search" />
        </SelectParameters>
    </asp:SqlDataSource>
</p>
