<%@ Page Title="" Language="C#" MasterPageFile="~/site1.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="_Default" enableEventValidation="false" %>
            ...
            <tr>
                ...
                <td class="style5">
                    <asp:TextBox ID="TextBox2" runat="server" Height="27px" 
                        ontextchanged="TextBox1_TextChanged" Width="210px" TextMode="Password"></asp:TextBox>
                </td>
                <td>
